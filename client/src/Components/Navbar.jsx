        ...
        <div className="bg-teal-500 flex justify-around items-center py-3 lg:px-20 px-10">
          ...
          <div className="hidden lg:flex list-none">
            <ul className='flex text-xl gap-10'>
              ...
              <li><Link to="/dashboard" className='p-2 border-transparent border-2 hover:border-black hover:bg-slate-200 hover:rounded-xl hover:scale-50'>Dashboard</Link></li>
